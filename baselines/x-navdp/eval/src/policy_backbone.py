"""
NavDP Policy Backbone - CNN encoders for RGB-D and goal inputs.

This module provides the RGB-D encoder used by point-goal evaluation.
"""
...
class NavDP_RGBD_Backbone(nn.Module):
    """RGB-D encoder using Depth Anything V2."""
